...
include_once ('AlibabaTaosellerVideoTaskQueryParam/ComAlibabaOceanOpenplatformBizVideoResultVideoTaskResult.class.php');

class AlibabaTaosellerVideoTaskQueryResult {
