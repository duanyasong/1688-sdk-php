    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->freeCarriageMinProductAmount = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "sumPaymentLimitMin", $this->arrayResult )) {
    			$this->sumPaymentLimitMin = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "supportFreeCarriage", $this->arrayResult )) {
    			$this->supportFreeCarriage = $arrayResult['${paramType.paramName}'];
    			}
