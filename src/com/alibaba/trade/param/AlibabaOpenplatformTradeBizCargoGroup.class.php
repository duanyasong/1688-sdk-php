...
include_once ('AlibabaTradeSaleproxyCreateOrderParam/AlibabaOpenplatformTradeJsonGoodsParam.class.php');
include_once ('AlibabaTradeSaleproxyCreateOrderParam/AlibabaOpenplatformTradeSpecInfo.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->cargoKey = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->packageNum = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->productAmount = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->buyerCharge = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->free = $arrayResult['${paramType.paramName}'];
    			}
    		...
    		$jsonGoodsParamResult=$arrayResult['${paramType.paramName}'];
    			    			$this->jsonGoodsParam = new AlibabaOpenplatformTradeJsonGoodsParam();
    			    			$this->jsonGoodsParam->setStdResult ( $jsonGoodsParamResult);
    		}
