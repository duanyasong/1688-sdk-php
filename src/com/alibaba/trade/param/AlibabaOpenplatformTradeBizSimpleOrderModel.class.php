...
include_once ('AlibabaTradeSaleproxyCreateOrderParam/AlibabaOpenplatformTradeBizSimpleOrderEntryModel.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->subBuyerUserId = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "succSumPayment", $this->arrayResult )) {
    			$this->succSumPayment = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "tbId", $this->arrayResult )) {
    			$this->tbId = $arrayResult['${paramType.paramName}'];
    			}
    		...
    		$orderEntryModelResult=$arrayResult['${paramType.paramName}'];
