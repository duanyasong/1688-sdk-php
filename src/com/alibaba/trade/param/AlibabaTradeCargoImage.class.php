    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->imageURI = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "searchImageURI", $this->arrayResult )) {
    			$this->searchImageURI = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "size310x310ImageURI", $this->arrayResult )) {
    			$this->size310x310ImageURI = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "summImageURI", $this->arrayResult )) {
    			$this->summImageURI = $arrayResult['${paramType.paramName}'];
    			}
    		    	    		}
