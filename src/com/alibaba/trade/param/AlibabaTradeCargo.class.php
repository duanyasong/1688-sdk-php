...
include_once ('AlibabaTradeSaleproxyPreorderParam/AlibabaTradeSubPayInfo.class.php');
include_once ('AlibabaTradeSaleproxyPreorderParam/AlibabaTradeSpecInfo.class.php');
include_once ('AlibabaTradeSaleproxyPreorderParam/AlibabaTradeCargoImage.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->attachedType = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "catTree", $this->arrayResult )) {
    			$this->catTree = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->dangerous = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->externalId = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->gift = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->maxPrice = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "maxQuantity", $this->arrayResult )) {
    			$this->maxQuantity = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->miniPrice = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "miniQuantity", $this->arrayResult )) {
    			$this->miniQuantity = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->orderCargoMaxPrice = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "orderCargoMinPrice", $this->arrayResult )) {
    			$this->orderCargoMinPrice = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->priceFactor = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->promotion = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->summImage = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->supplyMemberId = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "taoOfferId", $this->arrayResult )) {
    			$this->taoOfferId = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->unitPrice = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->isVirtual = $arrayResult['${paramType.paramName}'];
    			}
    		...
    		$subPayInforsResult=$arrayResult['${paramType.paramName}'];
    		...
    		$specInfoResult=$arrayResult['${paramType.paramName}'];
    		...
    		$imagesResult=$arrayResult['${paramType.paramName}'];
    			...
    			$this->mixSale = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "mixBegin", $this->arrayResult )) {
    			$this->mixBegin = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    		if (array_key_exists ( "productPromotionInfo", $this->arrayResult )) {
    		$productPromotionInfoResult=$arrayResult['${paramType.paramName}'];
    			    			$this->productPromotionInfo = new AlibabaTradeOpPromotionInfor();
    			    			$this->productPromotionInfo->setStdResult ( $productPromotionInfoResult);
    		}
    		    	    		}
