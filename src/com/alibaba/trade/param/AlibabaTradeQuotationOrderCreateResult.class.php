...
include_once ('AlibabaTradeQuotationOrderCreateParam/AlibabaOpenplatformTradeResultTradeCreateGeneralOrderResult.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    		...
    		$orderResultResult=$arrayResult['${paramType.paramName}'];
    			    			$this->orderResult = new AlibabaOpenplatformTradeResultTradeCreateGeneralOrderResult();
    			    			$this->orderResult->setStdResult ( $orderResultResult);
    		}
