    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->appointedArrivalDate = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "autoConfirmReceipt", $this->arrayResult )) {
    			$this->autoConfirmReceipt = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "buyerBizPhone", $this->arrayResult )) {
    			$this->buyerBizPhone = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "buyerCommpanyName", $this->arrayResult )) {
    			$this->buyerCommpanyName = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "calCarriage", $this->arrayResult )) {
    			$this->calCarriage = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "channel", $this->arrayResult )) {
    			$this->channel = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "checkCode", $this->arrayResult )) {
    			$this->checkCode = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->codServiceType = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "crossPromotionIds", $this->arrayResult )) {
    			$this->crossPromotionIds = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "crossShopPromotions", $this->arrayResult )) {
    			$this->crossShopPromotions = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->engine = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "extId", $this->arrayResult )) {
    			$this->extId = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "filledCarriage", $this->arrayResult )) {
    			$this->filledCarriage = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->guaranteeFee = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "lgArguments", $this->arrayResult )) {
    			$this->lgArguments = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "mergedJsonVar", $this->arrayResult )) {
    			$this->mergedJsonVar = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->needCheckCode = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "needCheckInstant", $this->arrayResult )) {
    			$this->needCheckInstant = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "needInstallment", $this->arrayResult )) {
    			$this->needInstallment = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "needRegist", $this->arrayResult )) {
    			$this->needRegist = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "orderCodFee", $this->arrayResult )) {
    			$this->orderCodFee = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "orderContractContent", $this->arrayResult )) {
    			$this->orderContractContent = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->payEntry = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "payTimeout", $this->arrayResult )) {
    			$this->payTimeout = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->selectedLogistics = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "sellerBizPhone", $this->arrayResult )) {
    			$this->sellerBizPhone = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->toleranceFreight = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->totalProductAmount = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "umpSysAvailble", $this->arrayResult )) {
    			$this->umpSysAvailble = $arrayResult['${paramType.paramName}'];
    			}
    		    	    		}
