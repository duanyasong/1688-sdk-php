    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->addressName = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "addressType", $this->arrayResult )) {
    			$this->addressType = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "areaName", $this->arrayResult )) {
    			$this->areaName = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "cityName", $this->arrayResult )) {
    			$this->cityName = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->fullAddress = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->leastCode = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->provinceName = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    			if (array_key_exists ( "sendGoodsContactor", $this->arrayResult )) {
    			$this->sendGoodsContactor = $arrayResult['${paramType.paramName}'];
    			}
    			...
    			$this->wangwangNo = $arrayResult['${paramType.paramName}'];
    			}
    		    	    		}
