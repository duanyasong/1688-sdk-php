...
include_once ('AlibabaDistributorGetSupplierFreightTemplatesParam/AlibabaOpenplatformLogisticsDeliveryRateDTO.class.php');
include_once ('AlibabaDistributorGetSupplierFreightTemplatesParam/AlibabaOpenplatformLogisticsDeliverySysRateDTO.class.php');
