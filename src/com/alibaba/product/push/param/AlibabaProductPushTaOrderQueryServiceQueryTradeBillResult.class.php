...
include_once ('AlibabaProductPushTaOrderQueryServiceQueryTradeBillParam/AlibabaProductPushTaTradeBillModel.class.php');

class AlibabaProductPushTaOrderQueryServiceQueryTradeBillResult {
