...
include_once ('AlibabaProductModifyStockParam/AlibabaProductSkuStockBean.class.php');
    ...
    */
	...
	public function setArrayResult($arrayResult) {
		$this->arrayResult = $arrayResult;
    			...
    			$this->productAmountChange = $arrayResult['${paramType.paramName}'];
    			}
    		    	    			    		    		if (array_key_exists ( "skuStocks", $this->arrayResult )) {
    		$skuStocksResult=$arrayResult['${paramType.paramName}'];
