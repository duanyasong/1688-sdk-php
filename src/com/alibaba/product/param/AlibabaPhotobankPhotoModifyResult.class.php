...
class AlibabaPhotobankPhotoModifyResult {
    ...
    */
    ...
    /**
     * 设置结果     
     * @param AlibabaProductImageInfo $result     
          
     * 此参数必填     */
    public function setResult(AlibabaProductImageInfo $result) {
        $this->result = $result;
    }
    ...
    */
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->result = new AlibabaProductImageInfo();
