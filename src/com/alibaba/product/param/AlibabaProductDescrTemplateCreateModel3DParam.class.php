...
include_once ('AlibabaProductDescrTemplateCreateModel3DParam/AlibabaProductProductAttribute.class.php');

class AlibabaProductDescrTemplateCreateModel3DParam {
