...
include_once ('AlibabaCaigouDictionaryAddRepositoriesParam/AlibabaCaigouCoopapiProductModelResultData.class.php');

class AlibabaCaigouDictionaryAddRepositoriesResult {
