...
include_once ('ComAlibabaProcurementBuyerSendGoodsServiceQuerySendGoodsNoteParam/AlibabaProcurementApiSendgoodsIntegrationResultIntegrationSendGoodsNoteModel.class.php');

class ComAlibabaProcurementBuyerSendGoodsServiceQuerySendGoodsNoteResult {
