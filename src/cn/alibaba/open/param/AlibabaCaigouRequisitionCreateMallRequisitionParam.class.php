...
include_once ('AlibabaCaigouRequisitionCreateMallRequisitionParam/AlibabaCaigouBizApiCooperParamOpenCreateRequisitionParam.class.php');

class AlibabaCaigouRequisitionCreateMallRequisitionParam {
