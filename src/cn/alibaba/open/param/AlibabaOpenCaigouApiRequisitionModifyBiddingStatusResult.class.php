...
include_once ('AlibabaOpenCaigouApiRequisitionModifyBiddingStatusParam/AlibabaCaigouBizApiCommonModelResultData.class.php');

class AlibabaOpenCaigouApiRequisitionModifyBiddingStatusResult {
